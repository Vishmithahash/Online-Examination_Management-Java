...
<body>
    ...
    <div class="ticket-container">
        ...
        <form action="StudentInsertServlet" method="POST">
            ...
            <input type="text" id="module-name" name="module" required>

            <label for="email">Email:</label>
            <input type="email" id="email" name="email" required>

            <label for="phone">Phone Number:</label>
            <input type="text" pattern="\d{10}" id="phone" name="no" required>
        ...
        <br><br>
        <a href="StudentAllServlet"><button>View Ticket</button></a>
    </div>
