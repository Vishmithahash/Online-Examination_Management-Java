...
@WebServlet("/ModuleInsertServelet")
public class ModuleInsertServelet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		isTrue = ContolModule.insertdata(subjectName, examinationDate, examinationTime, totalMarks, passingMarks, duration, questionFormat, studentGroup, gradingMethod);
